...
Route::get('/all','PageController@allProperties');
...
Route::get('/office','PageController@building');
...
Route::get('/house/search','PageController@housesearch');
...
Route::get('/office/search','PageController@buildingsearch');
