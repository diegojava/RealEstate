...
<head>
  ...
  <title>Administrator Panel - Jarming</title>
  ...
  <div class="columns panelboard">
    <div class="column is-one-fifth adminsidebar">
      <aside class="menu">
        ...
        <p class="menu-label is-4 is-size-7 has-text-weight-bold has-text-dark is-uppercase">
          <i class="fas fa-home"></i> Gestor de Propiedades
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/property/all">Todo</a></li>
          <li><a href="/admin/property/house">Casas</a></li>
          <li><a href="/admin/property/land">Terrenos</a></li>
          <li><a href="/admin/property/building">Oficinas</a></li>
          <li><a href="/admin/property/apartment">Departamentos</a></li>
        ...
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-lock"></i> Gestor de Reportes
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/report"> Ver Reportes</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fab fa-blogger-b"></i> Gestor de Noticias
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/blog/new">Nuevo Post</a></li>
          <li><a href="/admin/articles"> Ver Posts</a></li>
        </ul>
        {{--<p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
        ...
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-users"></i> Gestor de Usuarios
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/user/add">Nuevo Usuario</a></li>
          <li><a href="/admin/user/all">Ver Usuarios</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-user-shield"></i> Gestor de Administradores
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="/admin/admin/add">Nuevo Admin</a></li>
          <li><a href="/admin/admin/all">Ver Admins</a></li>
        </ul>
        <p class="menu-label has-text-dark is-4 is-size-7 has-text-weight-bold is-uppercase">
          <i class="fas fa-cogs"></i> Otros
        </p>
        <ul class="menu-list adminlistitem">
          <li><a href="{{ route('admin.logout') }}">Cerrar sesión</a></li>
        </ul>
      </aside>
    </div>
    @if(Request::is('admin'))
