...
<head>
    ...
    <title>Jarming - Real Estate</title>
    ...
    {{-- BUSCADOR --}}
      <div class="container">
               <div class="column is-full is-centered">
                   {{--<h1 class="subtitle is-4 has-text-black searchboxtitletext">Buscar propiedades</h1>--}}
                   <div class="tabs">
                    <ul>
                      <li class="is-active has-background-primary tabitem">
                        <a href="/house">
                          <span class="has-text-white">Casas</span>
                        </a>
                      </li>
                      <li  class="deadtabitem">
                        <a href="/land">
                          <span class="has-text-white">Terrenos</span>
                        </a>
                      </li>
                      <li class="deadtabitem">
                        <a href="/apartment">
                          <span class="has-text-white">Departamentos</span>
                        </a>
                      </li>
                      <li class="deadtabitem">
                        <a href="/office">
                          <span class="has-text-white">Oficinas</span>
                        </a>
                      </li>
                     {{-- <li class="deadtabitem">
                        <a href="warehouse">
                  ...
                  @csrf
                    <div class="field has-addons searchinput">
                        <p class="control has-icons-left is-expanded">
                          <input class="input is-large inputsearchbox" type="text" placeholder="Buscar por nombre, ciudad o descripcion..." id="search" name="searchquery">
                          <span class="icon is-small is-left">
                            <i class="fas fa-search"></i>
                          </span>
                        </p>
                        <div class="control">
                            <button class="button inputsearchbox is-primary is-large"><p class="subtitle is-6 has-text-white">Buscar</p></button>
                        </div>
                    </div>
