<div class="column displaybox">
  ...
  <nav class="breadcrumb has-arrow-separator has-background-white" aria-label="breadcrumbs">
    <ul>
      ...
      <li class="is-active"><a href="/profile">Cambiar Contraseña</a></li>
    </ul>
  </nav>
        ...
        <form action="/profile/updatepassword" method="post">
          ...
          <div class="field">
            <p class="control has-icons-left">
              <input class="input" type="password" placeholder="Contraseña Actual" name="current_password">
          ...
          <div class="field">
            <p class="control has-icons-left">
              <input class="input" type="password" placeholder="Confirma tu nueva contraseña" name="password_confirmation">
              <span class="icon is-small is-left">
                                                        <i class="fas fa-lock"></i>
                                                      </span>
            </p>
          ...
          <div class="field">
            <p class="control has-text-centered">
              <button class="button is-success" type="submit">
                                                <span class="buttonspace">Guardar</span>
                                              </button>
            </p>
          </div>
        </form>
