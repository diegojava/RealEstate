<div class="column displaybox profileback">
        ...
        <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><a href="/profile">Panel de Control</a></li>
            </ul>
        </nav>
        @if($user->description==null || $user->address==null || $user->city==null || $user->gender==null || $user->birthday==null || $user->phoneNo==null)
        <div class="columns is-mobile is-centered content">
            <div class="column is-half">
                <div class="notification is-warning">
                    <button class="delete"></button> {{ __('Completa tu perfil,')
                    }} <a href="/profile/editaccount">haz clic aquí para hacerlo.</a></div>
      ...
      @endif
        <div class="columns dashboxes profileback">
            <div class="column has-text-centered selecticon" onclick="location.href='/add'">
              ...
              <h6 class="is-uppercase has-text-weight-bold">Añadir propiedad</h6>
            </div>
            ...
            <div class="column has-text-centered selecticon" onclick="location.href='/profile/editaccount'">
              ...
              <h6 class="is-uppercase has-text-weight-bold">Editar Perfil</h6>
            </div>
            <div class="column has-text-centered selecticon" onclick="location.href='/profile/sold'">
              ...
              <h6 class="is-uppercase has-text-weight-bold">Habilitar/Deshabilitar Propiedades</h6>
            </div>
