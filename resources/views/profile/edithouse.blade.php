<div class="column displaybox">
    ...
    <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a href="/profile">Editar Propiedad</a></li>
        </ul>
    </nav>
    ...
    <div class="card cardmargin">
        <div class="containerx">
            ...
            <h1 class="title has-text-centered">Editar la Propiedad</h1>
                        ...
                        <div class="field">
                          ...
                          <div class="control">
                                ...
                                <div class="select is-primary is-full">
                                    ...
                                    <option selected>{{$house->property->currency}}</option>
                             ...
                             <div class="control">
                                ...
                                <div class="select is-primary is-full">
                                    ...
                                    <option selected>{{$house->property->contractType}}</option>
                    ...
                    <div class="column">
                        ...
                        <div class="field">
                            <div class="control">
                                ...
                                <input class="input is-primary" type="number" name="parkingSpaces" value="{{$house->parkingSpaces}}">
                            </div>
                        </div>
                        <div class="field">
                            <div class="control">
